...
const BurgerMenu = ({ menuItems, setBurgerClick, lottieRef }) => {
  ...
  return (
    <motion.div
      ...
      animate={"visible"}
      exit={"hidden"}
      className="absolute left-0 top-24 z-20 flex flex-col justify-around items-center text-xl font-[500]  rounded-lg md:hidden w-[100%] h-[200px]  text-violet-50 bg-purple-600 "
    >
